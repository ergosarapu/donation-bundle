...
#[Event(name: 'identity.organisation_reg_code_changed')]
final class IdentityOrganisationRegCodeChanged extends AbstractTimestampedEvent implements DomainEventInterface
{
    public function __construct(
        ...
        #[PersonalData]
        public readonly ?OrganisationRegCode $organisationRegCode,
    ) {
