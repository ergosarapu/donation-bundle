...
class MarkRecurringPlanAsFailingHandler implements CommandHandlerInterface
{
    ...
    public function __invoke(MarkRecurringPlanAsFailing $command): void
    {
        ...
        $recurringPlan->markFailing($this->clock->now());
