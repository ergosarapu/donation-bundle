...
class MarkRecurringDonationAsFailedHandler implements CommandHandlerInterface
{
    ...
    public function __invoke(MarkRecurringDonationAsFailed $command): void
    {
        ...
        $recurringDonation->markFailed($this->clock->now());
