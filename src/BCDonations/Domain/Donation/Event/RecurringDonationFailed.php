...
#[Event(name: 'recurring_donation.failed')]
class RecurringDonationFailed extends AbstractTimestampedEvent implements EventInterface
{
    ...
    public function __construct(
        ...
        $this->status = RecurringDonationStatus::Failed;
    }
