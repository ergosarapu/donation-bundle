 ...
 *     },
 * }
 * @psalm-type DonationConfig = array{
 *     form?: array{ // Form configuration.
 *         currencies?: array<string, array{ // Currency code // Default: []
 *             amount_default?: scalar|Param|null, // Default amount pre-filled for the end user.
 *             amount_choices?: list<scalar|Param|null>,
 *         }>,
 *     },
 *     gateways?: array<string, array{ // Default: []
 *         group?: scalar|Param|null, // The label of the gateway group shown to the end user
 *         label?: scalar|Param|null, // The label of payment gateway shown to the end user
 *         image?: scalar|Param|null, // The icon of payment gateway shown to the end user
 *         frequencies?: list<scalar|Param|null>,
 *         country?: scalar|Param|null, // Marks gateway as country specific so user can quickly filter gateways with same country. Must be valid alpha-2 country code.
 *     }>,
 * }
